...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
        <a class="navbar-brand ml-5" href="http://localhost/ally/index.php">My Food Recipe</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="form-inline my-2 my-lg-0 mr-5">
                <div class="dropdown">
                    <a class="nav-link dropdown-toggle link-unstyled" style="text-decoration: none; color: #eee;" href="admin_page.php" role="button" data-toggle="dropdown" aria-expanded="false">
                        My Account
                    </a>
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="read.php">Admin</a>
            ...
            <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h1 class="caption"><strong>Filipino Food Delicious</strong></h5>
                            <p class="caption caption-p">Certainly! Filipino cuisine is a fascinating blend of indigenous flavors, colonial influences, and regional variations. Let’s explore it further:</p>
                        </div>
                    </div>
                    <div class="carousel-item">
                        <img src="image/bg5.jpg" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
                            <h1 class="caption"><strong>Food is Love, Food is Life</strong></h1>
                            <p class="caption caption-p">When someone says “food is my love language,” they’re expressing that food plays a significant role in their emotional well-being and happiness. It’s like saying that sharing a meal or enjoying delicious dishes is a way to connect with others and express affection. </p>
                        </div>
                    </div>
                </div>
            </div>
